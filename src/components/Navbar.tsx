...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md" style={{ background: 'linear-gradient(135deg, rgba(252, 231, 243, 0.9), rgba(221, 214, 254, 0.9))', opacity: 0.9 }}>
